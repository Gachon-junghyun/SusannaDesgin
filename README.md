...
| 숫자 지표 | 홈·회사소개의 네 칸 숫자 띠 | 795 **평** 자체 공장 |
...
**남은 건 네이버 플레이스 인증입니다.** 대전 손님은 네이버에서 찾고, **지역 유입의 8할**이
여기서 옵니다. 웹 색인은 됐지만, 플레이스가 미인증이면(사진·리뷰·소개 없음) 전화는 잘 안 옵니다.

| | 어디서 | 걸리는 시간 |
|---|---|---|
| **네이버 스마트플레이스** ★ 가장 급함 | smartplace.naver.com | 심사 2시간~5일 |
