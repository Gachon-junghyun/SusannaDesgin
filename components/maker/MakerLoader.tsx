...
export default function MakerLoader({ mode, tool = "editor", base }: { mode: "admin" | "customer"; tool?: "editor" | "trace"; base: string }) {
  return tool === "trace" ? <TraceStudio base={base} /> : <SignMaker mode={mode} />;
}
