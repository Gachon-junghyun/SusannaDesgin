...
- ⚠️ **사양 칩을 화면으로 되돌렸습니다.** 2026-09-05 에 "사양 문구 «대신» 가격대" 로
  내렸던 것인데, 새 카드는 **가격과 사양이 각자 자리를 갖는** 배치라 둘이 안 부딪힙니다
  (가격이 여전히 더 큽니다). 🔴 **치수는 3D 씬의 가정값이라** 격자 아래에 그 사실을
  적어 뒀습니다 — **그 줄을 지우면 카드의 "80mm" 가 실측 약속이 됩니다** [P6].
