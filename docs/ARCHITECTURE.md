...
| 사진 | ⚠️ 실사진 **21장**(실적 17 · 사업영역 4 · 공정 1 · **공장/사옥 2**, 일부 공용). 2026-08-07 홈의 `about-factory.jpg` 를 **공장 내부 작업 장면**으로 갈아, 사옥 외관 1장을 두 자리에 돌려쓰던 상태가 풀렸습니다(`/about` 의 `about-office.jpg` 는 그대로). 남은 자리는 §7 |
