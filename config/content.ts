...
export const sectionCopy: Record<string, SectionCopy> = {
  ...
  "home-maker": {
    ...
    title: "간판 시안 미리보기",
    desc: "상호와 간판 종류를 넣으면 벽 위에 시안을 그려 보고, 제작 가능 여부를 mm 단위로 확인할 수 있는 서비스입니다.",
  },
  "home-cta": {
    eyebrow: "",
  ...
  cards: [
    {
      ...
      label: "글꼴 선택",
      title: "상호 입력과\n글꼴 선택",
      desc: "간판용 무료 글꼴 16종 또는 보유하신 글꼴 파일을 사용할 수 있습니다.",
    ...
    },
    {
      ...
      label: "간판 종류 선택",
      title: "간판 종류별\n조명 방식 비교",
      desc: "채널·후광·스카시 등 벽면 부착 간판 6종을 비교할 수 있습니다.",
    ...
    },
    {
      ...
      label: "원근 보정",
      title: "가게 사진 위\n네 점 원근 보정",
      desc: "비스듬한 벽면에도 간판 면을 맞춰 볼 수 있습니다.",
    ...
    },
    {
      ...
      label: "제작 가능 판정",
      title: "제작 가능 여부\nmm 단위 판정",
      desc: "절곡 채널 획 38mm, 조명 글자 높이 203mm 기준으로 판정합니다.",
